...
%%
% Book metadata
\title[SCINE ReaDuct manual]{User Manual \vskip 0.5em {\setlength{\parindent}{0pt} \Huge SCINE ReaDuct 6.1.0}}
...
\item \texttt{scf\_damping\_value}: The exact value to be used for the SCF damping. The default value is 0.5.
...
To this end, sets of atoms are forced onto one another, or pushed apart.
